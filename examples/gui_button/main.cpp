...
// Modified MakeButton to take color
...
DECL_HOOKv(CHud_Draw)
{
    ...
    if(!g_ButtonsInit)
    {
        // Example buttons (x%, y%, w%, h%)
        AddButton(0.05f, 0.05f, 0.09f, 0.08f, u"Top Left", [](){ logi("Top Left"); }, CRGBA(255,0,0,200));
        AddButton(0.65f, 0.05f, 0.3f, 0.08f, u"Top Right", [](){ logi("Top Right"); }, CRGBA(0,255,0,200));
        AddButton(0.35f, 0.45f, 0.3f, 0.08f, u"Center", [](){ logi("Center"); }, CRGBA(0,0,255,200));
        AddButton(0.05f, 0.85f, 0.3f, 0.08f, u"Bottom Left", [](){ logi("Bottom Left"); }, CRGBA(255,255,0,200));
        AddButton(0.65f, 0.85f, 0.3f, 0.08f, u"Bottom Right", [](){ logi("Bottom Right"); }, CRGBA(255,0,255,200));
...
for(auto& btn : g_Buttons)
{
    ...
    // --- Fixed text scale ---
    float scale = 0.9f; // fixed scale, adjust as needed
    ...
    // Optional: set center size to button width minus padding
    ...
    if(symAddr)
    {
        ...
        CFont_SetCentreSize(btnW * 0.8f);  // leave 20% padding horizontally
    }
...
extern "C" void OnModLoad()
{
    ...
    logi("Vice City Mod loaded: buttons hooked into CHud::Draw.");
}
